...
public class VentanaReporteVentas extends JFrame {
    ...
    public VentanaReporteVentas() {
        setTitle("Reporte Consolidado de Ventas - Panel de Administración");
        setSize(850, 500);
    ...
    public void cargarReporteGeneral() {
        ...
        try (Connection c = conex.getConnection()) {
            if (c != null) {
                ...
                etiquetaGranTotal.setText("TOTAL RECAUDADO EN CAJA: $ " + acumuladoCaja + " COP");
            }
        } catch (SQLException e) {
            System.out.println("Error SQL al generar el reporte de ventas: " + e.getMessage());
