...
public class DialogFacturaVenta extends JDialog {
	...
	public void cargarFactura(String numeroFactura, String fecha, String hora, String cliente, String identificacion,
			String direccion, String telefono, String subtotal, String impuestos, String total) {
	...
	public void agregarDetalleFactura(String producto, String cantidad, String precioUnitario, String impuestos,
			String subtotal) {
