...
public class ComprasBDDAO implements CompraDAO {
    ...
    private static final String SQL_ELIMINAR_COMPRA = "DELETE FROM " + TABLA_COMPRAS + " WHERE numeroFacturaProveedor = ?";
    ...
    private void prepararInsertDetalle(PreparedStatement sentencia, int idCompra,
