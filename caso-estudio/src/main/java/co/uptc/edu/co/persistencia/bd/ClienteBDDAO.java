...
public class ClienteBDDAO implements IGestionCliente {
	...
	public void guardar(Cliente cliente) throws Exception {
		...
		try (Connection connection = ConexionBD.getConexion();
			...
			throw new Exception("Error al guardar cliente: " + e.getMessage(), e);
		}
	}
	...
	public void actualizar(Cliente cliente) throws Exception {
		...
		try (Connection connection = ConexionBD.getConexion();
			...
			prepararActualizar(preparedStatement, cliente);
			preparedStatement.executeUpdate();
	...
	public List<Cliente> listar() throws Exception {
		...
		try (Connection connection = ConexionBD.getConexion();
			...
			while (resultSet.next()) {
				lista.add(construirCliente(resultSet));
			}
	...
	private Cliente construirCliente(ResultSet resultSet) throws SQLException {
		Cliente cliente = new Cliente();

		cliente.setCodigo(resultSet.getString("codigoCliente"));
		cliente.setNombre(resultSet.getString("nombre"));
		cliente.setTipoIdentificacion(TipoDocEnum.valueOf(resultSet.getString("tipoIdentificacion")));
		cliente.setNumeroIdentificacion(resultSet.getString("numeroIdentificacion"));
		cliente.setDireccion(resultSet.getString("direccion"));
		cliente.setTelefono(resultSet.getString("telefono"));
		cliente.setTipoCliente(TipoClienteEnum.valueOf(resultSet.getString("tipoCliente")));
		cliente.setEstado(EstadoEnum.valueOf(resultSet.getString("estado")));

		return cliente;
	}

	private void prepararInsert(PreparedStatement preparedStatement, Cliente cliente) throws SQLException {
		preparedStatement.setString(1, cliente.getCodigo());
		preparedStatement.setString(2, cliente.getNombre());
		preparedStatement.setString(3, cliente.getTipoIdentificacion().name());
		...
		preparedStatement.setString(7, cliente.getTipoCliente().name());
		preparedStatement.setString(8, cliente.getEstado().name());
	}

	private void prepararActualizar(PreparedStatement preparedStatement, Cliente cliente) throws SQLException {
		preparedStatement.setString(1, cliente.getNombre());
		preparedStatement.setString(2, cliente.getTipoIdentificacion().name());
		preparedStatement.setString(3, cliente.getNumeroIdentificacion());
		preparedStatement.setString(4, cliente.getDireccion());
		preparedStatement.setString(5, cliente.getTelefono());
		preparedStatement.setString(6, cliente.getTipoCliente().name());
		preparedStatement.setString(7, cliente.getEstado().name());
		preparedStatement.setString(8, cliente.getCodigo());
	}
}