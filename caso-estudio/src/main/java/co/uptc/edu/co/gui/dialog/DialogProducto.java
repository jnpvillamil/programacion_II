...
public class DialogProducto extends JDialog {
	...
	public Producto obtenerProducto() throws Exception {
		...
		validarCamposObligatorios(codigo, nombre, textoPrecioVenta, textoPrecioCompra, textoStockActual,
				textoStockMinimo, textoStockMaximo);
	...
	private void validarCamposObligatorios(String codigo, String nombre, String precioVenta, String precioCompra,
			String stockActual, String stockMinimo, String stockMaximo) throws Exception {
