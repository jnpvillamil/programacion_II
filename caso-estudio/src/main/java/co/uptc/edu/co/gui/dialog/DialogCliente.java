...
public class DialogCliente extends JDialog {
	...
	public Cliente obtenerCliente() throws Exception {
		...
		validarCamposObligatorios(codigo, nombre, numeroIdentificacion, direccion, telefono);

		EstadoEnum estado = modoEdicion ? estadoActual : EstadoEnum.ACTIVO;

		return new Cliente(codigo, nombre, tipoIdentificacion, numeroIdentificacion, direccion, telefono, tipoCliente,
				estado);
	}

	private void validarCamposObligatorios(String codigo, String nombre, String numeroIdentificacion, String direccion,
