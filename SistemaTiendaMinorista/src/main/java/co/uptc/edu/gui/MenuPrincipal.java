...
import co.uptc.edu.negocio.GestionProveedores;
...
public class MenuPrincipal extends JFrame {
    ...
    private JPanel crearPanelBotones() {
        ...
        // ================= BOTONES =================
        JButton btnClientes =
                crearBoton("Gestión Clientes");

        JButton btnProductos =
                crearBoton("Gestión Productos");

        JButton btnProveedores =
                crearBoton("Gestión Proveedores");

        JButton btnVentas =
                crearBoton("Gestión Ventas");

        JButton btnCompras =
                crearBoton("Gestión Compras");

        JButton btnContable =
                crearBoton("Gestión Contable");

        JButton btnConsultas =
                crearBoton("Módulo Consultas");

        JButton btnReportes =
                crearBoton("Panel de Reportes");
        ...
        btnProveedores.addActionListener(e -> {
            ...
            new co.uptc.edu.gui.GestionProveedores(
                    gestionProveedores
            ).setVisible(true);
        });
        ...
        // ================= CONTABLE =================
        btnContable.addActionListener(e -> {
