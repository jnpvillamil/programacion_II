...
public class ContabilidadGUI extends JFrame {
    ...
    private void iniciarComponentes() {
        ...
        btnActualizar.setActionCommand("ACTUALIZAR_MOVIMIENTO");
        btnEliminar .setActionCommand("ELIMINAR_MOVIMIENTO");
    ...
    public String obtenerCodigoMovimiento() {
        return txtCodigoTransaccion.getText().trim();
    }
    ...
    public void limpiarFormulario() {
    	...
    	cbTipoMovimiento.setToolTipText("");
