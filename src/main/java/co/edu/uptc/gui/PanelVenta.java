...
public class PanelVenta extends JPanel {
    public PanelVenta() {
        ...
        JLabel titulo = ConstructorComponentes.crearEtiquetaNegrita("MÓDULO DE VENTAS");
        ...
        // Tabla
        String[] cols = {"Cantidad", "Descripción", "Precio Unitario", "Subtotal"};
        ...
        panelSur.add(ConstructorComponentes.crearEtiquetaNegrita("Total Venta: $ 0.00"));
